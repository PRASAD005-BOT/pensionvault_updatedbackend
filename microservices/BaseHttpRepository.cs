...
public class BaseHttpRepository
{
    ...
    public BaseHttpRepository(HttpClient httpClient, IHttpContextAccessor httpContextAccessor)
    {
    ...
    protected void ApplyAuthHeader()
    {
        ...
        if (context != null && context.Request.Headers.TryGetValue("Authorization", out var authHeader))
        {
            ...
            {
                HttpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", val[7..]);
            }
        }
    }
