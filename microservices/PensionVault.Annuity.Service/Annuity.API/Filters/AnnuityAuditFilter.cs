...
namespace Annuity.API.Filters;

public class AnnuityAuditFilter : IAsyncActionFilter
{
    private readonly AuditServiceClient _auditClient;

    public AnnuityAuditFilter(AuditServiceClient _auditClient)
    {
        this._auditClient = _auditClient;
    }
