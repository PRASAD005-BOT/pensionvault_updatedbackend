...
using Serilog;
using PensionVault.Annuity.Service.Middleware;
...
using PensionVault.Annuity.Service.ProxyRepositories;
using PensionVault.Annuity.Service.ProxyServices;
...
Log.Information("PensionVault Annuity Service starting on port 7003");
app.Run();
